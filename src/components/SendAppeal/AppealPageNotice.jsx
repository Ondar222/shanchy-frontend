    ...
    return (
        <div className="font-mono [&>p]:py-1">
            <p>Просим Вас внимательно ознакомиться с порядком приема и рассмотрения обращений,
                направленных в адрес Администрации Чаа-Хольского кожууна.</p>
            <p>Обращения, поступившие в адрес Администрации Чаа-Хольского кожууна,
            ...
            <p>Вы можете направить обращение в Администрацию Чаа-Хольского кожууна:</p>
            <p>- путем заполнения соответствующей формы, размещенной на официальном сайте</p>
            <p>- путём его направления на почтовый или электронный адрес Администрации Чаа-Хольского кожууна.</p>
            <p>- путем звонка по телефону приемной Администрации Чаа-Хольского кожууна.</p>

            <p>1. Обращения, направленные в форме электронного документа через официальный сайт, поступают на
                рассмотрение в Администрацию Чаа-Хольского кожууна и рассматриваются
                работниками
                Администрации Чаа-Хольского кожууна.</p>
